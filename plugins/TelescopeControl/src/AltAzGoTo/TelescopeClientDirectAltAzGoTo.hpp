...
#ifndef TELESCOPECLIENTDIRECTAltAzGoTo_HPP
#define TELESCOPECLIENTDIRECTAltAzGoTo_HPP
...
class TelescopeClientDirectAltAzGoTo : public TelescopeClient, public Server
{
	Q_OBJECT
public:
	TelescopeClientDirectAltAzGoTo(const QString &name, const QString &parameters, Equinox eq = EquinoxJ2000);
	~TelescopeClientDirectAltAzGoTo(void)
	{
		//hangup();
	}
...
private:
	...
	//======================================================================
	// Members inherited from ServerAltAzGoTo
	AltAzGoToConnection *AltAzGoTo;
...
#endif // TELESCOPECLIENTDIRECTAltAzGoTo_HPP
